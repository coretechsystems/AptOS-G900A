...
busybox echo "persist.audio.hifi.int_codec=true" >> /system/build.prop
busybox echo "lpa.use-stagefright=false" >> /system/build.prop
busybox echo "ro.lenovo.hifi_support=true" >> /system/build.prop
